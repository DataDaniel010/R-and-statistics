...
You can create non valid names using backtick (\`)
...
-   если в документации функции есть аргументы, у которых через = что-то написано, то это
    означает, что эти параметры имеют значения по умолчанию
